      ...
      {hours.map(({timeText, time}, index) => {
        return (
          <React.Fragment key={time}>
            <Text
              key={`timeLabel${time}`}
              style={[styles.timeLabel, {top: offset * index - 6 + 24, width: timelineLeftInset - 16}]}
            >
              {timeText}
            </Text>
            <View
              ...
              style={[
                styles.line,
                {top: offset * index + 24, width: dimensionWidth - EVENT_DIFF, left: timelineLeftInset - 16}
              ]}
            />
            {time === end ? null : (
              <View
                ...
                style={[
                  styles.line,
                  {height: 0.6, backgroundColor: '#E9E9E9'},
                  {top: offset * (index + 0.5) + 24, width: dimensionWidth - EVENT_DIFF, left: timelineLeftInset - 16}
                ]}
              />
            )}
          </React.Fragment>
